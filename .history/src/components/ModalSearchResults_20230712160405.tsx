            ...
            <FormControl sx={{ m: 1, width: "100%" }} variant="filled">
              <Grid item xs={12} sx={{ marginTop: 2 }}>
                <Grid container>
                  ...
                  <Grid item xs={6} sx={{ marginTop: 2 }}>
                    <FilledInput
                      id="filled-roomQuantity"
                      aria-describedby="filled-roomQuantity"
                      inputProps={{
                        "aria-label": `${t("maximum")}: 5`,
                      }}
                      value={reservations.room.roomQuantity}
                      aria-label={t("roomQuantity")}
                    />
                    <FormHelperText id="filled-roomQuantity" />
                  </Grid>
                </Grid>
              </Grid>
            </FormControl>
