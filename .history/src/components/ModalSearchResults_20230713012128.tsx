...
const ModalSearchResults = ({
  ...
  useEffect(() => {
    if (reservations && reservations.stay) {
                ...
                <Grid container>
                  ...
                  <Grid item xs={12} sx={{ marginTop: 2 }}>
                    <TextField
                      ...
                      defaultValue={reservations.note}
                      variant="standard"
                    />
                  </Grid>
                  <Grid item xs={12} sx={{ marginTop: 2 }}>
                    ...
                    {reservations.tags &&
                      reservations.tags.map((tag: string) => (
                        <Chip
                          key={tag}
                          label={t(tag)}
                          onDelete={() => {}}
                  ...
                  <Grid item xs={12} sx={{ marginTop: 2 }}>
                    <FormGroup>
                      <FormControlLabel
                        control={<Switch checked={reservations.reminder} />}
                        label={t("sendReminder")}
                      />
                      <FormControlLabel
                        control={<Switch checked={reservations.newsletter} />}
                  ...
                  <Grid item xs={12} sx={{ marginTop: 2 }}>
                    <FormControlLabel
                      control={<Checkbox checked={reservations.confirm} />}
